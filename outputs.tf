...
//output "public_workers_role_arn" {
//  description = "ARN of the worker nodes IAM role"
//  value       = module.eks_public_workers.workers_role_arn
//}
//
//output "public_workers_role_name" {
//  description = "Name of the worker nodes IAM role"
//  value       = module.eks_public_workers.workers_role_name
//}
output "private_workers_role_arn" {
  description = "ARN of the worker nodes IAM role"
  value       = module.eks_private_workers.workers_role_arn
}

output "private_workers_role_name" {
  description = "Name of the worker nodes IAM role"
  value       = module.eks_private_workers.workers_role_name
}
